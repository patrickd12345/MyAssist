...
async function main() {
  ...
  const server = new McpServer(
    { name: "job-hunt-manager", version: "0.1.0" },
    {
      instructions:
        "Job Hunt aggregator for MyAssist: search_jobs (needs track id), save_job with track or new_track, lifecycle tools. Configure JOB_HUNT_*_RSS_URLS for feeds. Optional JOB_HUNT_DEMO_JOBS=true when no RSS. Data file: " +
        dataPath,
    },
  );
  ...
  server.registerTool(
    ...
    {
      description:
        "Search and aggregate jobs (RSS/API-light connectors). Requires a known track id (list_tracks). Results are deduped, ranked, and cached for get_job/save_job.",
      inputSchema: {
        ...
        sort: z.enum(["relevance", "feed"]).optional(),
      },
    },
    async (args) => {
      try {
  ...
  server.registerTool(
    ...
    async (args) => {
      try {
        return jsonResult(await svc.getJob(args.id));
      } catch (e) {
        return errResult(e instanceof Error ? e.message : String(e));
      }
    },
  ...
  server.registerTool(
    ...
    {
      description:
        "Save a lead to storage. Requires job id from search_jobs cache. Pass track id or new_track inline.",
      inputSchema: {
        id: z.string().min(1),
    ...
    async (args) => {
      try {
        ...
        return jsonResult(await svc.saveJob(args));
      } catch (e) {
        return errResult(e instanceof Error ? e.message : String(e));
      }
    },
  ...
  server.registerTool(
    ...
    async (args) => {
      try {
        const a = args ?? {};
        return jsonResult({ tracks: await svc.listTracks(a.include_archived ?? false) });
      } catch (e) {
        return errResult(e instanceof Error ? e.message : String(e));
      }
    },
  ...
  server.registerTool(
    ...
    async (args) => {
      try {
        return jsonResult({ track: await svc.createTrack(args) });
      } catch (e) {
        return errResult(e instanceof Error ? e.message : String(e));
      }
    },
  ...
  server.registerTool(
    ...
    async (args) => {
      try {
        await svc.archiveTrack(args.track_id);
  ...
  server.registerTool(
    ...
    async (args) => {
      try {
        return jsonResult(await svc.markApplied(args));
      } catch (e) {
        return errResult(e instanceof Error ? e.message : String(e));
      }
    },
  ...
  server.registerTool(
    ...
    async (args) => {
      try {
        return jsonResult({ items: await svc.listSavedJobs(args) });
      } catch (e) {
        return errResult(e instanceof Error ? e.message : String(e));
      }
    },
  ...
  server.registerTool(
    ...
    async (args) => {
      try {
        return jsonResult(await svc.updateJobProgress(args));
      } catch (e) {
        return errResult(e instanceof Error ? e.message : String(e));
      }
    },
  ...
  server.registerTool(
    ...
    async (args) => {
      try {
        ...
        return jsonResult(await svc.addInterviewTranscript(args));
      } catch (e) {
        return errResult(e instanceof Error ? e.message : String(e));
      }
    },
  ...
  server.registerTool(
    ...
    async (args) => {
      try {
        return jsonResult(await svc.logTouchpoint(args));
      } catch (e) {
        return errResult(e instanceof Error ? e.message : String(e));
      }
    },
  ...
  server.registerTool(
    ...
    async (args) => {
      try {
        return jsonResult(await svc.scoreSigningProbability(args));
      } catch (e) {
        return errResult(e instanceof Error ? e.message : String(e));
      }
    },
